...
BATCH_SIZE = 500  # MODIFIÉ: Augmentation du nombre de factures à traiter par lot (était 100)
MAX_INVOICES_PER_RUN = 0  # 0 = pas de limite, sinon limite le nombre de factures à envoyer par exécution
